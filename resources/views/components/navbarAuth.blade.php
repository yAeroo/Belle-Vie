<header class="bg-[#f87171] md:z-40 font-body">
  <nav class="flex justify-between items-center w-[92%] mx-auto md:z-40">
      ...
      <div class="flex items-center gap-6 sm:gap-[1.75rem] md:z-0">
          <ion-icon onclick="onToggleMenu(this)" name="menu" class="text-3xl cursor-pointer md:hidden md:z-0" color="light"></ion-icon>
      </div>
</header>
