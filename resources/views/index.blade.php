    ...
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div class="sm:flex sm:items-center sm:justify-between">
            <a href="#" class="flex items-center mb-4 sm:mb-0">
                <img src="{{ asset('img/favicon.png') }}" class="h-8 mr-3" alt="Flowbite Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Belle Vie</span>
            </a>
            <ul class="flex flex-wrap items-center mb-6 text-sm font-medium text-white ">
                ...
                <li>
                    <a href="https://github.com/yAerosmith/Belle-Vie" class="mr-4 hover:underline md:mr-6">Respositorio</a>
                </li>
        </div>
        <hr class="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
        <span class="block text-sm text-white sm:text-center ">© 2023 <a href="https://flowbite.com/" class="hover:underline">Belle Vie™</a></span>
    </div>
</footer>
</body>
</html>